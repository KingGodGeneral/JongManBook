 ...
 * A 가 그 다음에 고를 수 있는 쌍의 수는 B 보다 많거나 같음.
 * 따라서 가정에 모순되기 때문에 A 가 항상 B 보다 많거나 같은 쌍을 만들 수 있음이 증명됨
 * 증명을 이렇게 하면 되는건지 모르겠어서..태클환영입니다.
 *
 * bitset을 쓴 이유는 bool 배열 만들고 memset하기 귀찮아서...
 * 57번째 줄의 bitset<100000> b = 1; 는 위의 prev = 0 과 같은 역할을 합니다.
 */
